...
public class CompleteDriverRegistrationActivity extends Activity {
    ...
    private void savePictureToDTO(){
        ...
        new CarDAO(CompleteDriverRegistrationActivity.this).saveOrUpdateCar(carDTO);
    }
    ...
    private boolean validateForm(){
        ...
        if(TextUtils.isEmpty(txtCarDetails.getText().toString())) {
            Utils.showToast(CompleteDriverRegistrationActivity.this, getResources().getString(R.string.activity_complete_driver_registration_car_details_error));
            validForm = false;
        }
       ...
       /* else if(TextUtils.isEmpty(txtPlateNum.getText().toString())){
            ...
            Utils.showToast(CompleteDriverRegistrationActivity.this, getResources().getString(R.string.activity_complete_driver_registration_image_error));
            validForm = false;
        }
    ...
    private void showMenu() {
        menuDialog = new Dialog(CompleteDriverRegistrationActivity.this, R.style.WalkthroughTheme);
    ...
    private void deletePicture(final boolean all){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(CompleteDriverRegistrationActivity.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
            builder = new AlertDialog.Builder(CompleteDriverRegistrationActivity.this);
        }
    ...
    private void openCamera(){
        if (
                ActivityCompat.checkSelfPermission(CompleteDriverRegistrationActivity.this, Manifest.permission.CAMERA ) != PackageManager.PERMISSION_GRANTED
            ||  ActivityCompat.checkSelfPermission(CompleteDriverRegistrationActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE ) != PackageManager.PERMISSION_GRANTED
            ||  ActivityCompat.checkSelfPermission(CompleteDriverRegistrationActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE )!= PackageManager.PERMISSION_GRANTED ) {

            ActivityCompat.requestPermissions(CompleteDriverRegistrationActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, PERMISSION_CAMERA);
        }
        else {
