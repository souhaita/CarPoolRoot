...
public class ActivityProfile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = Utils.getCurrentAccount(ActivityProfile.this);

        prepareDataList();
        profileAdapter = new ProfileAdapter(ActivityProfile.this, profileObjectList);

        recyclerView = (RecyclerView) findViewById(R.id.recycleViewProfile);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(ActivityProfile.this, LinearLayoutManager.VERTICAL, false);
